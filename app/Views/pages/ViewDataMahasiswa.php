        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="nama" size="255" placeholder="Nama" id="inputNama" class="form-control <?= $err = (session()->get('fail_add')) ? (($validation->hasError('nama')) ? 'is-invalid' : '') : ''; ?>" value="<?= old('nama'); ?>" required>
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="TmpLahir" size="255" placeholder="TempatLahir" id="inputTempatLahir" class="form-control <?= $err = (session()->get('fail_add')) ? (($validation->hasError('TmpLahir')) ? 'is-invalid' : '') : ''; ?>" value="<?= old('TmpLahir'); ?>" required>
                ...
                <div class="form-floating mb-3">
                    <input type="date" name="TglLahir" placeholder="TanggalLahir" id="inputTanggalLahir" class="form-control <?= $err = (session()->get('fail_add')) ? (($validation->hasError('TglLahir')) ? 'is-invalid' : '') : ''; ?>" value="<?= old('TglLahir'); ?>" required>
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="alamat" size="255" placeholder="Alamat" id="inputAlamat" class="form-control <?= $err = (session()->get('fail_add')) ? (($validation->hasError('alamat')) ? 'is-invalid' : '') : ''; ?>" value="<?= old('alamat'); ?>" required>
                ...
                <div class="form-floating mb-3">
                    <input type="number" name="telepon" maxlength="13" placeholder="Telepon" id="inputTelepon" pattern="{0-9}+" class="form-control <?= $err = (session()->get('fail_add')) ? (($validation->hasError('telepon')) ? 'is-invalid' : '') : ''; ?>" value="<?= old('telepon'); ?>" required>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-md-3">
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-control <?php if (old('nim_edit') === $row->nim_mhs) : ?><?= $err = (session()->get('fail_edit')) ? (($validation->hasError('jenkel_edit')) ? 'is-invalid' : '') : ''; ?><?php endif; ?>" name="jenkel_edit" id="jenkel_edit" required>
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-control <?php if (old('nim_edit') === $row->nim_mhs) : ?><?= $err = (session()->get('fail_edit')) ? (($validation->hasError('agama_edit')) ? 'is-invalid' : '') : ''; ?><?php endif; ?>" name="agama_edit" id="agama_edit" required>
                                    <?php if (session()->get('fail_edit') && $validation->hasError('pendidikan_edit')) { ?>
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-control <?php if (old('nim_edit') === $row->nim_mhs) : ?><?= $err = (session()->get('fail_edit')) ? (($validation->hasError('jurusan_edit')) ? 'is-invalid' : '') : ''; ?><?php endif; ?>" name="jurusan_edit" id="jurusan_edit" required>
                                    <?php if (session()->get('fail_edit') && $validation->hasError('pendidikan_edit')) { ?>
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-control <?php if (old('nim_edit') === $row->nim_mhs) : ?><?= $err = (session()->get('fail_edit')) ? (($validation->hasError('pendidikan_edit')) ? 'is-invalid' : '') : ''; ?><?php endif; ?>" name="pendidikan_edit" id="pendidikan_edit" required>
                                    <?php if (session()->get('fail_edit') && $validation->hasError('pendidikan_edit')) { ?>
